<div class="min-h-screen bg-gray-50 py-24" id="berita">
...
<script>
    ...
    function updatePagination() {
        ...
        for (let i = 1; i <= totalPages; i++) {
            ...
            pageLink.href = '#';
            pageLink.className = `relative inline-flex items-center px-4 py-2 border ${i === currentPage ? 'bg-secondary text-white' : 'bg-white text-gray-700'} text-sm font-medium `;
